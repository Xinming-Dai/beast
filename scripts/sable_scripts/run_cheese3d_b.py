#!/usr/bin/env python3
"""
B: Cheese3D mask-bbox pseudo-correspondence smoke test.

Validates:
  Cheese3D masks -> 5 pseudo-correspondences -> init_gs Kabsch branch
  -> debug merged point cloud outputs.
"""
import os
import sys
...
def main() -> None:
    ...
    config_path = os.path.join(REPO_ROOT, "configs/sable_cheese3d_b.yaml")
    output_dir = os.path.join(REPO_ROOT, "outputs/cheese3d_phase2_b")
