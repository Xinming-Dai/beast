...
#SBATCH -o /u/xdai3/project3d/SBALE_repo/beast/scripts/sable_scripts/encoding_decoding/img_token/step1_run_decoding_%j.log
#SBATCH --export=ALL
...
# Neural decoding: predicts (e.g. compressed) img tokens / other latents from neural activity.
# Fill these in (or export before sbatch, e.g.:
#   sbatch --export=ALL,EID=<session-id>,... \
#     scripts/sable_scripts/encoding_decoding/img_token/step1_run_decoding.sh
...
LATENT_KIND="${LATENT_KIND:-img_tokens_compressed}"         # frame | mu_s | psae | mu_u | depth | cat | img_tokens_compressed*
