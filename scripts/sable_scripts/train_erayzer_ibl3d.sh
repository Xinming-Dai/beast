...
#SBATCH -t 0-04:00:00
#SBATCH -J erz_train
#SBATCH -o /u/xdai3/project3d/SBALE_repo/beast/scripts/sable_scripts/train_erayzer_ibl3d_%j.log
#SBATCH --export=ALL
...
RESUME_CKPT="${RESUME_CKPT:-/work/nvme/bfsr/xdai3/project3d/twoview3d_ckpts/beast_erayzer/781b35fd-e1f0-4d14-b2bb-95b7263082bb/18441450/tb_logs/version_0/checkpoints/epoch=11-step=1376-best.ckpt}"
