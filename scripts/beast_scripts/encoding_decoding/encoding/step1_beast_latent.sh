...
JOB_ID=20505751
MODEL_DIR="${MODEL_DIR:-/work/nvme/bfsr/xdai3/project3d/twoview3d_ckpts/beast_vit_large/$EID/$JOB_ID}"
...
echo "[$(date +'%Y-%m-%d %H:%M:%S')] Extracting ViT-large per-image latents -> $OUTPUT_DIR"
