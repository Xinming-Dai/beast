...
#SBATCH --mem=32G
#SBATCH -t 0-1:00:00
#SBATCH -J beast_encoding
#SBATCH -o /u/xdai3/project3d/SBALE_repo/beast/scripts/beast_scripts/encoding_decoding/encoding/step2_run_encoding_%j.log
#SBATCH --export=ALL
...
LATENT_INPUT_DIR=/work/nvme/bfsr/xdai3/project3d/twoview3d_ckpts/beast_vit_large/$EID/$JOB_ID/latents
