...
#SBATCH --mem=32G
#SBATCH -t 0-1:00:00
#SBATCH -J beast_cheese3d_encoding
#SBATCH -o /u/xdai3/project3d/SBALE_repo/beast/scripts/beast_scripts/encoding_decoding/cheese3d/step2_run_encoding_%j.log
#SBATCH --export=ALL
...
# Neural encoding: predicts neural activity from beast (ViT-base) latents (RRR/CNN, via Ray
...
LATENT_INPUT_DIR=/projects/bfsr/xdai3/project3d/twoview3d_ckpts/beast_vit/cheese3d/$JOB_ID/latents
