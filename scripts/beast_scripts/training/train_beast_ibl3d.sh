...
#SBATCH -t 0-1:59:00
#SBATCH -J beast_ibl
#SBATCH -o /u/xdai3/project3d/SBALE_repo/beast/scripts/beast_scripts/training/train_beast_vit_ibl3d_%j.log
#SBATCH --export=ALL
...
CONFIG="${CONFIG:-$REPO_ROOT/configs/vit_for_SABLE_baseline.yaml}"
...
CHECKPOINT_BASE="${CHECKPOINT_DIR:-/projects/bfsr/xdai3/project3d/twoview3d_ckpts/beast_vit/$EID}"
