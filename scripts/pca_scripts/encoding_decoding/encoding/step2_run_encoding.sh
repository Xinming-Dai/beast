...
#SBATCH --mem=32G
#SBATCH -t 0-1:00:00
#SBATCH -J pca_encoding
#SBATCH -o /u/xdai3/project3d/SBALE_repo/beast/scripts/pca_scripts/encoding_decoding/encoding/step2_run_encoding_%j.log
#SBATCH --export=ALL
...
# Neural encoding: predicts neural activity from PCA autoencoder latents (RRR/CNN, via Ray Tune).
...
LATENT_INPUT_DIR=/projects/bfsr/xdai3/project3d/twoview3d_ckpts/pca_ae/$EID/$JOB_ID/latents
