...
#SBATCH --mem=48G
#SBATCH -t 0-00:59:00
#SBATCH -J pca_extraction
#SBATCH -o /u/xdai3/project3d/SBALE_repo/beast/scripts/pca_scripts/encoding_decoding/encoding/step1_latent_%j.log
#SBATCH --export=ALL
...
JOB_ID=21557552
MODEL_DIR="${MODEL_DIR:-/projects/bfsr/xdai3/project3d/twoview3d_ckpts/pca_ae/$EID/$JOB_ID}"
