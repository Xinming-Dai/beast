...
#SBATCH -t 0-00:59:00
#SBATCH -J pca_ibl
#SBATCH -o /u/xdai3/project3d/SBALE_repo/beast/scripts/pca_scripts/training/train_pca_ibl3d_%j.log
#SBATCH --export=ALL
...
CONFIG="${CONFIG:-$REPO_ROOT/configs/pca.yaml}"

# Data paths (override by exporting before sbatch, e.g.:
#   sbatch --export=ALL,DATASET_PATH=/path/to/frames scripts/pca_scripts/training/train_pca_ibl3d.sh)
STAGE=finetune
...
CHECKPOINT_BASE="${CHECKPOINT_DIR:-/projects/bfsr/xdai3/project3d/twoview3d_ckpts/pca_ae/$EID}"
