...
#SBATCH --mem=32G
#SBATCH -t 0-1:00:00
#SBATCH -J resnet_cheese3d_encoding
#SBATCH -o /u/xdai3/project3d/SBALE_repo/beast/scripts/resnet_scripts/encoding_decoding/cheese3d/step2_run_encoding_%j.log
#SBATCH --export=ALL
...
# Neural encoding: predicts neural activity from ResNet-18 autoencoder latents (RRR/CNN, via Ray
...
LATENT_INPUT_DIR=/projects/bfsr/xdai3/project3d/twoview3d_ckpts/resnet_ae_18/cheese3d/$JOB_ID/latents
