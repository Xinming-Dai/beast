...
class PerceptualLoss(nn.Module):
    ...
    def __init__(self, checkpoint_root='metric_checkpoint', device='cpu'):
        """Initialize.

        Args:
            checkpoint_root: directory to search for the VGG matconvnet weights.
    ...
    def _load_matconvnet_weights(self, model):
